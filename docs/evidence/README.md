...
Sanitized production artifacts and eval results. All files are synthetic/redacted; real tokens, internal URLs, and client data never appear here.

## Index

| File | Status | Description |
|---|---|---|
| `eval_report_local.md` | Committed | S04 local eval results: recall@k, abstension correctness, citation integrity |
